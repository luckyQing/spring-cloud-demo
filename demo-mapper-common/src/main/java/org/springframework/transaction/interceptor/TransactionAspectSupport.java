	...
	protected PlatformTransactionManager determineTransactionManager(@Nullable TransactionAttribute txAttr) {
		...
		if (StringUtils.hasText(qualifier)) {
			...
			if (defaultTransactionManager == null) {
				...
				if (defaultTransactionManager == null) {
					// ----start
					DefaultTransactionAttribute defaultTransactionAttribute = (DefaultTransactionAttribute) txAttr;
					String descriptor = defaultTransactionAttribute.getDescriptor();
					for (Map.Entry<Object, PlatformTransactionManager> entry : transactionManagerCache.entrySet()) {
						if (descriptor.startsWith(entry.getKey().toString())) {
