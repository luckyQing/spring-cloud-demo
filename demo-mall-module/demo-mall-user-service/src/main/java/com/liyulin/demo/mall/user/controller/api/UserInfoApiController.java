...
public class UserInfoApiController {
	...
	public Resp<UserInfoBaseRespBody> queryById(@RequestBody @Valid Req<@NotNull QueryUserInfoByIdReqBody> req) {
		return RespUtil.success(userInfoApIService.queryById(req.getBody()));
	}
