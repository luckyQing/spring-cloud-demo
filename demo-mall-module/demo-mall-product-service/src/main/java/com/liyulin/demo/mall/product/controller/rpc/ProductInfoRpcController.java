...
public class ProductInfoRpcController implements ProductInfoRpc {
	...
	@Override
	public Resp<QryProductByIdsRespBody> qryProductByIds(@RequestBody @Valid Req<@NotNull QryProductByIdsReqBody> req) {
		return RespUtil.success(productInfoRpcService.qryProductByIds(req.getBody()));
	}
